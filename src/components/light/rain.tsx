...
const Rain = ({
  ...
  const id_09_svg__a = React.useId();
  const id_09_svg__b = React.useId();
  const id_09_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_149_1401"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
