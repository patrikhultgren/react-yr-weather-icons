...
const PartlyCloudyDay = ({
  ...
  const id_03d_svg__a = React.useId();
  const id_03d_svg__b = React.useId();
  const id_03d_svg__c = React.useId();
  const id_03d_svg__d = React.useId();
  const id_03d_svg__e = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_03d_svg__a})`}>
        <path
          fill={`url(#${id_03d_svg__b})`}
          fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_149_1385"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
