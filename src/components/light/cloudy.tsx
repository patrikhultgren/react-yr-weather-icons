...
const Cloudy = ({
  ...
  const id_04_svg__a = React.useId();
  const id_04_svg__b = React.useId();
  const id_04_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_149_1388"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
