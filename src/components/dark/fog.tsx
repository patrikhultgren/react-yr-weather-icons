...
const Fog = ({
  ...
  const id_15_svg__a = React.useId();
  const id_15_svg__b = React.useId();
  const id_15_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_15_svg__a})`}>
        ...
        <path
          fill="#ACACAC"
          d="M88.7 79H14.3c-.7 0-1.3-.7-1.3-1.5s.6-1.5 1.3-1.5h74.4c.7 0 1.3.7 1.3 1.5s-.6 1.5-1.3 1.5m-2 16H12.3c-.7 0-1.3-.7-1.3-1.5s.6-1.5 1.3-1.5h74.4c.7 0 1.3.7 1.3 1.5s-.6 1.5-1.3 1.5m-10-8H2.3c-.7 0-1.3-.7-1.3-1.5S1.6 84 2.3 84h74.4c.7 0 1.3.7 1.3 1.5s-.6 1.5-1.3 1.5"
        />
      </g>
      <defs>
        <linearGradient
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7271"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
