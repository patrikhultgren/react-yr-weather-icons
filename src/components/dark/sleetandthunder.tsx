...
const SleetAndThunder = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_23_svg__a = React.useId();
  const id_23_svg__b = React.useId();
  const id_23_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7427"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
