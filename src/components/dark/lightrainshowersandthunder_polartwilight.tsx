...
const LightRainShowersAndThunderPolarTwilight = ({
  ...
  const id_24m_svg__a = React.useId();
  const id_24m_svg__b = React.useId();
  const id_24m_svg__c = React.useId();
  const id_24m_svg__d = React.useId();
  const id_24m_svg__e = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_24m_svg__a})`}>
        <path
          fill={`url(#${id_24m_svg__b})`}
          fillRule="evenodd"
        ...
        <path
          fill="#00B8F1"
          d="M31.5 99c-.3 0-.7-.1-1-.2-1.3-.6-1.8-2-1.3-3.3l3.5-8c.6-1.3 2-1.8 3.3-1.3 1.3.6 1.8 2 1.3 3.3l-3.5 8c-.4 1-1.3 1.5-2.3 1.5m30-9c-.3 0-.7-.1-1-.2-1.3-.6-1.8-2-1.3-3.3l3.5-8c.6-1.3 2-1.8 3.3-1.3 1.3.6 1.8 2 1.3 3.3l-3.5 8c-.4 1-1.3 1.5-2.3 1.5"
        />
        <path
          fill="#FF9D00"
          fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7467"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
