...
const RainShowersAndThunderPolarTwilight = ({
  ...
  const id_06m_svg__a = React.useId();
  const id_06m_svg__b = React.useId();
  const id_06m_svg__c = React.useId();
  const id_06m_svg__d = React.useId();
  const id_06m_svg__e = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_06m_svg__a})`}>
        <path
          fill={`url(#${id_06m_svg__b})`}
          fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7031"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
