...
const RainShowersNight = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_05n_svg__a = React.useId();
  const id_05n_svg__b = React.useId();
  const id_05n_svg__c = React.useId();
  const id_05n_svg__d = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_05n_svg__a})`}>
        <path
          fill={`url(#${id_05n_svg__b})`}
          fillRule="evenodd"
          d="M28.443 13.565c0-3.869-1.116-7.514-2.902-10.638 9.666 1.234 17.247 8.91 18.378 18.607A29.7 29.7 0 0 0 33.9 30.4h-1.1c-4.9 0-9.4 2.3-12.1 6.2-4.058.243-7.853 1.673-11.01 4.128a21.9 21.9 0 0 1-5.275-6.11c.892.148 1.785.222 2.752.222 11.754 0 21.276-9.522 21.276-21.275"
          clipRule="evenodd"
        />
        <path
          fill="#B2B2B2"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_6987"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
