...
const HeavyRainAndThunder = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_11_svg__a = React.useId();
  const id_11_svg__b = React.useId();
  const id_11_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7213"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
