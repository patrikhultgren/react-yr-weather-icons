...
const LightRainAndThunder = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_30_svg__a = React.useId();
  const id_30_svg__b = React.useId();
  const id_30_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7831"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
