...
describe("Cloudy", () => {
  ...
  it("renders title when provided", () => {
    render(<Cloudy title="Cloudy title" titleId="cloudy-title" />);
    const title = screen.getByTitle("Cloudy title");
  ...
  it("accepts and applies width and height props", () => {
    render(<Cloudy width="100px" height="150px" />);
    const svg = screen.getByRole("img", { hidden: true });
  ...
  it("accepts and applies className prop", () => {
    render(<Cloudy className="my-custom-class" />);
    const svg = screen.getByRole("img", { hidden: true });
