...
const HeavyRain = ({
  ...
  const id_10_svg__a = React.useId();
  const id_10_svg__b = React.useId();
  const id_10_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7193"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
