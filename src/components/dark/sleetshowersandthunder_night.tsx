...
const SleetShowersAndThunderNight = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_20n_svg__a = React.useId();
  const id_20n_svg__b = React.useId();
  const id_20n_svg__c = React.useId();
  const id_20n_svg__d = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_20n_svg__a})`}>
        <path
          fill={`url(#${id_20n_svg__b})`}
          fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7333"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
