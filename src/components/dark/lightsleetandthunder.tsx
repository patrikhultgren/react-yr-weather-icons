...
const LightSleetAndThunder = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_31_svg__a = React.useId();
  const id_31_svg__b = React.useId();
  const id_31_svg__c = React.useId();
  return (
    <svg
    ...
    >
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7845"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
