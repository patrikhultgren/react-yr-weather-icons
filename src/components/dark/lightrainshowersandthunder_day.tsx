...
const LightRainShowersAndThunderDay = ({
  title,
  titleId,
  ...props
}: SVGProps<SVGSVGElement> & SVGRProps) => {
  const id_24d_svg__a = React.useId();
  const id_24d_svg__b = React.useId();
  const id_24d_svg__c = React.useId();
  const id_24d_svg__d = React.useId();
  const id_24d_svg__e = React.useId();
  return (
    <svg
    ...
    >
      ...
      <g clipPath={`url(#${id_24d_svg__a})`}>
        <path
          fill={`url(#${id_24d_svg__b})`}
          fillRule="evenodd"
      ...
      <defs>
        ...
        >
          ...
          <feGaussianBlur
            result="effect1_foregroundBlur_1334_7448"
            stdDeviation={3.5}
          />
        </filter>
      </defs>
